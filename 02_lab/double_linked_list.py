...
print('2. Print element with index 3: ')
test_list.print_index(3)
print()

print('3. Delete element with index 4 then delete el. with index 3:')
test_list.delete(4)
test_list.delete(3)
test_list.print_all()
print()

print('4. Insert element at index 0, then insert element at index 3: ')
test_list.insert("Samochodzik", 0)
test_list.insert("Autobusik", 3)
test_list.print_all()
print()

print('5. Delete element with index 5 then with index 1: ')
test_list.delete(5)
test_list.delete(1)
test_list.print_all()
print()

print('6. Check integrity of double linked list: ')
test_list.info_all()